...
<html lang="en">
    <head>
        <title>Infinity Study : UGC NET</title>
        <link href="f1346d0b-0866-4e5b-b818-515fd4e73670_200x200.ico" type="image" rel="icon">
        <link href="ugcnet.css" rel="stylesheet" type="text/css">
        <link href="ugcnet_small.css" rel="stylesheet" type="text/css" media="only screen and (max-device-width:768px)">
        <link href="bootstrap-3.4.1-dist/css/bootstrap.min.css" rel="stylesheet" type="text/css">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Here you can download UGC NET previous year question paper with answer keys & solutions...">
        <meta name="keywords" content="ugc net,contact us,contact infinity study,question papers,infinity study,study,infinitystudy,answer key,exams,entrance exams question paper,previous year papers,jee main papers,neet,jee main question papers">
...
if(isset($_SESSION['username'])){
        ...
        <div class="updates"><p>UGC NET</p></div>
        <div class="tabl">

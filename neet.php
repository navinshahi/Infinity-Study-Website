...
<html lang="en">
    <head>
        <title>Infinity Study : NEET</title>
        <link href="f1346d0b-0866-4e5b-b818-515fd4e73670_200x200.ico" type="image" rel="icon">
        <link href="neet.css" rel="stylesheet" type="text/css">
        <link href="neet_small.css" rel="stylesheet" type="text/css" media="only screen and (max-device-width:768px)">
        <link href="bootstrap-3.4.1-dist/css/bootstrap.min.css" rel="stylesheet" type="text/css">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Here you can download NEET(UG) previous year question paper with answer keys & solutions...">
        <meta name="keywords" content="neet,contact us,contact infinity study,question papers,infinity study,study,infinitystudy,answer key,exams,entrance exams question paper,previous year papers,jee main papers,neet,jee main question papers">
...
if(isset($_SESSION['username'])){
        ...
        <div class="updates"><p>NEET (UG)</p></div>
        <div class="tabl">
